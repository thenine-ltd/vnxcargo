...
<div class="page-container sticky-gallery classic-gallery">
    ...
    <div class="vc_row">
        <div class="vc_col-lg-5 vc_col-md-6 vc_col-sm-12 woo-product-image<?php if ( $featured_video ) { echo esc_attr(' -with-featured-video'); } ?> <?php echo $image_zoom ? esc_attr('with-zoom') : '' ?>">
        ...
        <div class="vc_col-lg-7 vc_col-md-6 vc_col-sm-12 woo-product-details -sticky-block">
