...
if ( $brand_color ) {
    ...
    $_selector = [
        ...
        '.woo-products .product-item.-type2 .button-group .added_to_cart:not(.-outlined):not(.-flat):not(.-text):not(.-primary):hover', 
        '.woo-products .product-item.-type2 .button-group .added_to_cart:not(.-outlined):not(.-flat):not(.-text):not(.-primary):active', 
        '.woo-products .product-item.-type2 .button-group .added_to_cart:not(.-outlined):not(.-flat):not(.-text):not(.-primary):focus'
    ];
    ...
    $_selector = [
        ...
        '.product-item.-type1 .added_to_cart:not(.-outlined):not(.-flat):not(.-text):not(.-primary):not(.-pagination):not(.elementor-button[type=submit]):hover',
        '.product-item.-type1 .added_to_cart:not(.-outlined):not(.-flat):not(.-text):not(.-primary):not(.-pagination):not(.elementor-button[type=submit]):active',
        '.product-item.-type1 .added_to_cart:not(.-outlined):not(.-flat):not(.-text):not(.-primary):not(.-pagination):not(.elementor-button[type=submit]):focus',
...
if ( $buttons_css ) {
    $_selector = [
        ...
        '.product-item.-type1 a.added_to_cart:not(.-outlined):not(.-text):not(.-flat)',
        'input[type="submit"]'
    ];
