    ...
    acf_add_local_field_group( [
        ...
        "fields" => [
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __( 'Show comments area on post pages?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 1,
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __( 'Show', 'ohio') . '&nbsp;' . __( '"Next Post"', 'ohio') . '&nbsp;' . __( 'navigation?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 1,
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __( 'Show author widget on post pages?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 1,
