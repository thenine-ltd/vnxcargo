    ...
    acf_add_local_field_group( [
        ...
        "fields" => [
            ...
            [
                ...
                "label" => __( 'Hamburger menu caption', 'ohio' ),
                "name" => "hamburger_menu_caption",
                "type" => "inherited_checkbox",
                "instructions" => __( 'Show hamburger menu caption?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "custom_labels" => [
                    "inherit" => __( 'Use from Theme Settings', 'ohio' ),
            ...
            [
                ...
                "type" => "radio",
                "instructions" => __( 'Choose page headline subtitle type', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "choices" => [
            ...
            [
                ...
                "label" => __( 'Author visibility', 'ohio' ),
                "name" => "header_title_author_visibility",
                "type" => "true_false",
                "instructions" => __( 'Show author in the page headline?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Date visibility', 'ohio' ),
                "name" => "header_title_date_visibility",
                "type" => "true_false",
                "instructions" => __( 'Show date in the page headline?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Comments visibility', 'ohio' ),
                "name" => "header_title_comments_visibility",
                "type" => "true_false",
                "instructions" => __( 'Show comments details in the page headline?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Page headline subtitle text', 'ohio' ),
                "name" => "header_title_custom_subtitle_text",
                "type" => "text",
                "instructions" => __( 'Page headline subtitle custom text', 'ohio' ),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __( 'Font Awesome 6 Icons', 'ohio' ),
                "name" => "icon_preloading_fontawesome",
                "type" => "inherited_checkbox",
                "instructions" => __( 'Enable Font Awesome 6 icons preloading on this page?', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "custom_labels" => [
                    "inherit" => __( 'Use from Theme Settings', 'ohio' ),
