...
<?php
	...
	$columns_num = OhioOptions::get_global( 'blog_columns_in_row' );
	...
	if ( $posts_layout_item == 'blog_grid_6' || $posts_layout_item == 'blog_grid_7' ) {
				...
				<div class="vc_row archive-holder <?php echo esc_attr( $grid_style_class . $grid_offset_class ); ?>" data-lazy-container="posts" <?php echo esc_attr( $asymmetric_atts ); ?>>
					...
					<?php
						...
						foreach ( $posts_array as $post_index => $post ) {
							...
							if ( $_parsed_post['grid_style'] == '2col' && !$posts_layout_item == 'blog_grid_6' && !$posts_layout_item == 'blog_grid_7' ) {
							...
							switch ( $posts_layout_item ) {
								...
								case 'blog_grid_6':
									...
									break;
								case 'blog_grid_7':
									get_template_part( 'parts/blog_grid/layout_type7' );
									break;
								default:
									get_template_part( 'parts/blog_grid/layout_type1' );
									break;
