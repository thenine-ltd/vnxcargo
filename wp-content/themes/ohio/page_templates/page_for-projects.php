...
<?php
	...
	$filter_layout = OhioOptions::get( 'project_filter_layout', 'default' );
								...
								<?php if ( is_array( $cat_ids ) && $cat_ids ) : ?>
									...
									<div class="portfolio-filter<?php echo esc_attr( $filter_classes ); ?>"
										...
										<ul class="-unlist">
											...
											<li>
												<a class="active<?php if ( $filter_layout == 'button' ) { echo esc_attr( ' tag -unlink'); } ?>" href="#all" data-isotope-filter="*" data-category-count="<?php echo str_pad( (string)$published_projects, 2, '0', STR_PAD_LEFT ); ?>">
