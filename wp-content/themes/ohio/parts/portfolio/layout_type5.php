...
$dark_mode = OhioOptions::get( 'page_dark_mode', false );
...
<div class="project-page project -layout5<?php echo esc_attr( $page_container_class ); ?>">
    ...
    <div class="page-container<?php echo esc_attr( $custom_page_container_class ); ?><?php echo esc_attr( $dark_mode_class ); ?>">
