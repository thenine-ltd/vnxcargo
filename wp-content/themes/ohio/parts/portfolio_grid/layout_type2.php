...
<div class="portfolio-item card -layout2<?php echo esc_attr( $wrapper_classes); ?>" <?php echo esc_attr( $parallax_data ); ?> <?php if ( $project['in_popup'] ) { echo ' data-portfolio-popup="' . esc_attr( $project['popup_id'] ) . '"'; } ?>>
