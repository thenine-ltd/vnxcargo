...
<div class="portfolio-item -with-slider -layout6<?php echo esc_attr( $fullscreen_class ); ?>" <?php if ( $project['in_popup'] ) { echo ' data-portfolio-popup="' . esc_attr( $project['popup_id'] ) . '"'; } ?>>
    <div class="portfolio-item-image -full-h -full-w" <?php echo ' data-ohio-bg-image="' . esc_url( $project['featured_image'] ) . '"'; ?> <?php echo esc_attr( $parallax_data ); ?>></div>
    <div class="project overlay">
        <div class="project-content -left animated-holder">
            ...
            <a class="project-title -unlink" href="<?php echo esc_url( $project['url'] ); ?>"<?php if ( $project['external'] ) {
                ...
                <h3 class="headline <?php if ( isset( $title_class ) ) echo esc_attr( $title_class ); ?>"><?php echo esc_html( $project['title'] ); ?></h3>
            </a>
