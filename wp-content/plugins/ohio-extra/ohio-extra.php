...
if ( in_array( $ohio_extra_get_theme->get( 'TextDomain' ), array( 'ohio', 'ohio-child' ) ) ) {
	...
	function ohio_extra_admin_style_and_scripts() {
		wp_enqueue_style( 'ohio-extra-styles', plugin_dir_url( __FILE__ ) . 'assets/css/ohio-extra.css', [], '3.3.1' );
		wp_enqueue_style( 'ohio-admin-wpbakery-styles', plugin_dir_url( __FILE__ ) . 'assets/css/wpbakery.css', [], '3.3.1' );

		wp_enqueue_script( 'ohio-extra-scripts', plugin_dir_url( __FILE__ ) . 'assets/js/main.js', [], '3.3.1' );
	}
		...
		<div class="share-bar -vertical">
			...
			<?php
				foreach ( $social_networks as $link ) {
					switch ( $link ) {
						case 'facebook':
							echo '<a class="-unlink" href="' . $facebook_link . '" target="' . $target_blank . '"><i class="network fa-brands fa-facebook-f"></i></a>';
							break;
						case 'twitter':
							echo '<a class="-unlink" href="' . $twitter_link . '" target="' . $target_blank . '"><i class="network fa-brands fa-x-twitter"></i></a>';
							break;
						case 'linkedin':
							echo '<a class="-unlink" href="' . $linkedin_link . '" target="' . $target_blank . '"><i class="network fa-brands fa-linkedin"></i></a>';
							break;
						case 'pinterest':
							echo '<a class="-unlink" href="' . $pinterest_link . '" target="' . $target_blank . '"><i class="network fa-brands fa-pinterest"></i></span></a>';
							break;
					}
				}
			?>
		...
		<div class="share-bar -vertical" data-blog-share="true">
			...
			<?php
				foreach ( $social_networks as $link ) {
					switch ( $link ) {
						case 'facebook':
							echo '<a href="' . $facebook_link . '" target="' . $target_blank . '" class="facebook network"><i class="fa-brands fa-facebook-f"></i></a>';
							break;
						case 'twitter':
							echo '<a href="' . $twitter_link . '" target="' . $target_blank . '" class="twitter network"><i class="fa-brands fa-x-twitter"></i></a>';
							break;
						case 'linkedin':
							echo '<a href="' . $linkedin_link . '" target="' . $target_blank . '" class="linkedin network"><i class="fa-brands fa-linkedin"></i></a>';
							break;
						case 'pinterest':
							echo '<a href="' . $pinterest_link . '" target="' . $target_blank . '" class="pinterest network"><i class="fa-brands fa-pinterest"></i></a>';
							break;
					}
				}
			?>
