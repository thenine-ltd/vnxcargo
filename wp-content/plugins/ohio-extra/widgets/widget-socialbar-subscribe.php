...
if ( ! class_exists( 'ohio_widget_socialbar_subscribe' ) ) {
		...
		function widget( $args, $instance ) {
			...
			<div class="social-networks -outlined">
				...
				<?php if ( !empty( $threads ) ) : ?>
					<a href="<?php echo esc_url( $threads ); ?>" target="_blank" class="network">
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'threads' ) ); ?>"><?php esc_html_e( 'Threads', 'ohio-extra' ); ?></label>
