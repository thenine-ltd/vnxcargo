...
<div class="portfolio-grid<?php if ( preg_replace("/[^0-9.]/", '', $settings['grid_items_gap'] ) == '0' ) { echo esc_html(' -nospace'); } ?>" data-projects-per-page="<?php echo $per_page?>" data-isotope-grid="true" data-lazy-container="projects" data-tilt-effect="true">
    ...
    <?php
        ...
        for ( $_post_i = $_post_start; $_post_i < $_post_end; $_post_i++ ) :
            ...
            $ohio_project['excerpt_visible'] = $settings['show_excerpt'];
