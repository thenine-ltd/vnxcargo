...
use WPStaging\Vendor\Composer\Script\Event;
use InvalidArgumentException;
use WPStaging\Vendor\Symfony\Component\Filesystem\Filesystem;
...
class Composer
{
     ...
     */
    public static function cleanup(\WPStaging\Vendor\Composer\Script\Event $event, \WPStaging\Vendor\Symfony\Component\Filesystem\Filesystem $filesystem = null)
    {
        ...
        if ($servicesToKeep) {
            ...
            $filesystem = $filesystem ?: new \WPStaging\Vendor\Symfony\Component\Filesystem\Filesystem();
    ...
    {
        $finder = (new \WPStaging\Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0');
    ...
    private static function getServicesToRemove($serviceDir, array $servicesToKeep)
    {
        ...
        return (new \WPStaging\Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0')->in($serviceDir)->exclude($servicesToKeep);
    }
}
