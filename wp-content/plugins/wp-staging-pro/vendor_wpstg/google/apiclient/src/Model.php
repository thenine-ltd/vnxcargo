...
class Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \WPStaging\Vendor\Google\Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \WPStaging\Vendor\Google\Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
    /** @return bool */
