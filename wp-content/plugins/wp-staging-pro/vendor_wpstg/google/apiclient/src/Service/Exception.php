...
class Exception extends \WPStaging\Vendor\Google\Exception
{
    /**
     ...
     */
    public function __construct($message, $code = 0, \WPStaging\Vendor\Google\Service\Exception $previous = null, $errors = [])
    {
