...
use WPStaging\Vendor\Firebase\JWT\Key;
    ...
    public function verifyIdToken($idToken, $audience = null)
    {
        ...
        foreach ($certs as $cert) {
            try {
                ...
                if (\class_exists(\WPStaging\Vendor\Firebase\JWT\Key::class)) {
                    $args[] = new \WPStaging\Vendor\Firebase\JWT\Key($publicKey, 'RS256');
                } else {
                    $args[] = $publicKey;
                    $args[] = ['RS256'];
                }
