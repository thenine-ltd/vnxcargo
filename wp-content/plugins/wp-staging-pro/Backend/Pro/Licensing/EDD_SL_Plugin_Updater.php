...
/**
 * WP STAGING DEVS:
 * DON'T MODIFY THIS CLASS! It's not PSR and does not follow WP STAGING coding style. It's an updater class included in the software by EDD: https://easydigitaldownloads.com/downloads/software-licensing/
 * For easy updating whenever EDD releases a new version of EDD Software Licenses add-on
 * we need to keep the code differences as small as possible.
 *
 * @updated October 5th, 2023 Rene Hermenau
 */
