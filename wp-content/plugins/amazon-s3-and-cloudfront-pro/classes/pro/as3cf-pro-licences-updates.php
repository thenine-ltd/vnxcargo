...
class AS3CF_Pro_Licences_Updates extends Delicious_Brains_API_Licences {
	...
	public function get_licence_info( $skip_transient_check = false ) {
		...
		$result = array();
		$result['licence_name'] = 'activated';
		$result['display_name'] = 'activated';
		$result['user_email'] = 'activated@deliciousbrains.com';
		$result['support_contacts'] = 'activated@deliciousbrains.com';
