var AestheticIconPicker = function (option) {
    "use strict";
    var fontAwesome = {
        "font-awesome": {
            "regular": {
    ...
    if ((!option.hasOwnProperty('selector') || 0 == option.selector.length) || (!option.hasOwnProperty('onClick') || 0 == option.onClick.length)) {
        // console.log('no selector or click');
        return;
    }
    ...
    // if( typeof defaultOpt.iconLibrary == 'object' ){
    // 	Object.assign(iconLibrary, defaultOpt.iconLibrary);
    // }
    ...
    if (null == selector) {
        return; //if not finding selector return user
    }
    ...
    var aestheticWrap = '<div class="aim-modal aim-open" id="aim-modal"><div class="aim-modal--content"><div class="aim-modal--header"><div class="aim-modal--header-logo-area"><span class="aim-modal--header-logo-title">Choose your channel icon</span></div><div class="aim-modal--header-close-btn"><i class="fas fa-times" title="Close"></i></div></div><div class="aim-modal--body"><div id="aim-modal--sidebar" class="aim-modal--sidebar"><div class="aim-modal--sidebar-tabs"></div></div><div id="aim-modal--icon-preview-wrap" class="aim-modal--icon-preview-wrap"><div class="aim-modal--icon-search"><input name="" value="" placeholder="Filter by name..."><i class="fas fa-search"></i></div><div class="aim-modal--icon-preview-inner"><div id="aim-modal--icon-preview"></div></div></div></div><div class="aim-modal--footer"><button type="button" class="aim-cancel-icon-button">Cancel</button><button type="button" class="aim-insert-icon-button">Insert</button></div></div></div>';
    ...
    var sidebarTabs = aestheticDomEle.querySelector('.aim-modal--sidebar-tabs');
    var previewWrap = aestheticDomEle.querySelector('#aim-modal--icon-preview');
    var searchInput = aestheticDomEle.querySelector('.aim-modal--icon-search input');
    ...
    document.querySelector(defaultOpt.onClick).addEventListener('click', function (e) {
        ...
        if (null == selector.querySelector('.aim-modal')) {
            ...
            aestheticDomEle.classList.remove('aim-close');
            aestheticDomEle.classList.add('aim-open');
        }

        jQuery("#aim-modal").removeClass("aim-close").addClass("aim-open");

        //document.querySelector('.aim-open .aim-modal--icon-search input').focus();

        //Icon library close by clicking close button
        aestheticDomEle.querySelector('.aim-modal--header-close-btn').addEventListener('click', function (e) {
        ...
        aestheticDomEle.querySelector('.aim-insert-icon-button').addEventListener('click', function (e) {
            ...
            if (null !== selected) {
                ...
                var dataSlug = jQuery(this).closest(".icon-picker-wrap").data("slug");
                if(jQuery(this).closest("#icon-select-chat").length) {
                    jQuery("#chat-fa-icon .svg-chat-icon").html("<i class='"+selectedClass+"'></i>");
                    jQuery("#chat-fa-icon .widget-fa-icon").val(selectedClass);
                } else if(jQuery("#image_agent_data_"+dataSlug).length) {
                    jQuery("#image_agent_data_"+dataSlug).removeClass("img-active").addClass("icon-active");
                    jQuery("#image_agent_data_"+dataSlug+" span.facustom-icon").html("<i class='"+selectedClass+"'></i>");
                    jQuery("#image_agent_data_"+dataSlug+" .fa-icon").val(selectedClass);
                    jQuery("#image_agent_data_"+dataSlug+" .image-id").val("");
                } else if(jQuery("#chaty_image_"+dataSlug).length) {
                    jQuery("#chaty_image_" + dataSlug + " .facustom-icon").html("<i class='" + selectedClass + "'></i>");
                    jQuery("#chaty_image_"+dataSlug).addClass("icon-active").removeClass("img-active");
                    jQuery("#chaty_image_"+dataSlug+ " .fa-icon").val(selectedClass);
                    jQuery("#cht_social_image_"+dataSlug).val("");
                }
        ...
        aestheticDomEle.querySelector('.aim-cancel-icon-button').addEventListener('click', function (e) {
            e.preventDefault();;
            aestheticDomEle.classList.remove('aim-open');
            aestheticDomEle.classList.add('aim-close')
        });
