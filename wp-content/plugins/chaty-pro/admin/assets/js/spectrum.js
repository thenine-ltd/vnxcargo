...
(function (factory) {
    ...
    function getOffset(picker, input)
    {
            ...
            offsetLeft -= Math.min(
                offsetLeft,
                (offsetLeft + dpWidth > viewWidth && viewWidth > dpWidth) ? Math.abs(offsetLeft + dpWidth - viewWidth) : 0
            );

            offsetTop -= Math.min(
                offsetTop,
                ((offsetTop + dpHeight > viewHeight && viewHeight > dpHeight) ? Math.abs(dpHeight + inputHeight - extraY) : extraY)
            );
    ...
    if (typeof inputTypeColorSupport._cachedResult === "undefined") {
        ...
        // if color element is supported, value will default to not null
    ...
    (function () {
        ...
        tinycolor.readability = function (color1, color2) {
            ...
            var colorDiff   = (
                Math.max(rgb1.r, rgb2.r) - Math.min(rgb1.r, rgb2.r) + Math.max(rgb1.g, rgb2.g) - Math.min(rgb1.g, rgb2.g) + Math.max(rgb1.b, rgb2.b) - Math.min(rgb1.b, rgb2.b)
            );
