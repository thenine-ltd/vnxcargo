                    ...
                    <?php if($licenseData['license'] == "expired") { ?>
                        <div class="manage-plan">
                            ...
                            <div class="plan-website-limit">
                                (<?php echo sprintf(esc_html__("%1\$d of %2\$d websites used", "folders"), esc_attr($siteCount), esc_attr($totalActivation)); ?>)
                            </div>
                                ...
                                <?php if($expireDate == "lifetime") {
                                    ...
                                    if(isset($response['data']['rec_amount'])) { ?>
                                        <div class="renewal-desc">
                                            <?php echo sprintf(esc_html__("You will be billed %1\$s", "folders"), "<b>$".esc_attr($response['data']['rec_amount'])."</b>") ?>
                                        </div>
                                    <?php }
                                } ?>
                            </div>
